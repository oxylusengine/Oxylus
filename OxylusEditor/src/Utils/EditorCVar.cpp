  ...
  const auto root = toml::table{
    {"editor_config",
     toml::table{
       ...
       {"grid", (bool)self.cvar_draw_grid.get()},
       ...
       {"camera_smooth", (bool)self.cvar_camera_smooth.get()},
       {"file_thumbnails", (bool)self.cvar_file_thumbnails.get()},
       {"file_thumbnail_size", self.cvar_file_thumbnail_size.get()},
       {"show_meta_files", self.cvar_show_meta_files.get()},
     }}
  };
