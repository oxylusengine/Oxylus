...
struct option_flag_val {
  constexpr static auto nullopt = ox::nullopt;
};
...
template <>
struct option_flag_val<f64, std::enable_if_t<std::numeric_limits<double>::is_iec559>> {
...
public:
  ...
  [[nodiscard]]
  constexpr T value_or(this SelfT&& self, U&& default_value) {
