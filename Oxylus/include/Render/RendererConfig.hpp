...
inline AutoCVar_Int cvar_debug_view("rr.debug_view", "0: None, 1: Triangles, 2: Meshlets, 3: Overdraw, 4: Materials, 5: Mesh Instances, 6: Mesh LoDs, 7: Albedo Color, 8: Normal Color, 9: Emissive Color, 10: Metallic Color, 11: Roughness Color, 12: Baked Ambient Occlusion, 13: Screen Space Ambient Occlusion, 14: Virtual Shadowmaps", 0);
...
inline AutoCVar_Float cvar_contact_shadows_length("pp.contact_shadows_thickness", "contact shadows length", 0.01f);
